...
if ( ! defined( 'PORCH_TITLE' ) ) {
    define( 'PORCH_TITLE', 'Home Hardwired' ); // Used in tabs and titles, avoid special characters. Spaces are okay.
}
...
if ( ! defined( 'PORCH_TYPE' ) ) {
    define( 'PORCH_TYPE', 'Hardwired' ); // Alphanumeric key. Use underscores not hyphens. No special characters.
}
if ( ! defined( 'PORCH_TOKEN' ) ) {
    define( 'PORCH_TOKEN', 'porch_app_hardwired' ); // Alphanumeric key. Use underscores not hyphens. No special characters. Must be less than 20 characters
}

class DT_Porch_Template_Home_Hardwired extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
    ...
    public function __construct() {
        ...
        if ( empty( $url ) && ! dt_is_rest() ) {
            ...
            add_action( 'init', [ 'DT_Porch_Template_Home_Hardwired_Storage', 'register_post_type' ] );
        }
    ...
    public function body(){
        echo DT_Porch_Template_Home_Hardwired_Storage::get_body(); // @phpcs:ignore
    }
...
DT_Porch_Template_Home_Hardwired::instance();


class DT_Porch_Template_Home_Hardwired_Storage {
