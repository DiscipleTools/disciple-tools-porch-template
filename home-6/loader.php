...
if ( ! defined( 'PORCH_TITLE' ) ) {
    define( 'PORCH_TITLE', 'Home 6' ); // Used in tabs and titles, avoid special characters. Spaces are okay.
}
...
if ( ! defined( 'PORCH_TYPE' ) ) {
    define( 'PORCH_TYPE', '6' ); // Alphanumeric key. Use underscores not hyphens. No special characters.
}
if ( ! defined( 'PORCH_TOKEN' ) ) {
    define( 'PORCH_TOKEN', 'porch_app_6' ); // Alphanumeric key. Use underscores not hyphens. No special characters. Must be less than 20 characters
}
