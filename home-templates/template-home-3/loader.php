...
class DT_Porch_Template_Home_3 extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
    public $page_title = 'Home 3';
    public $root = 'porch_app';
    public $type = '3';
    public static $token = 'porch_app_3';
    ...
    public function header_javascript(){
        ...
        <link rel="stylesheet" href="<?php echo trailingslashit( esc_url( plugin_dir_url( __FILE__ ) ) ) ?>css/slicknav.css">
...
DT_Porch_Template_Home_3::instance();