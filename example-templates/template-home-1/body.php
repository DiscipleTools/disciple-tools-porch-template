    ...
    <nav class="header-nav">
        ...
        <div class="header-nav__content">
            ...
            <ul class="header-nav__social">
                <li>
                    <a href="#" target="_blank" rel="noreferrer noopener"><i class="fab fa-facebook"></i></a>
                </li>
                <li>
                    <a href="#" target="_blank" rel="noreferrer noopener"><i class="fab fa-twitter"></i></a>
                </li>
                <li>
                    <a href="#" target="_blank" rel="noreferrer noopener"><i class="fab fa-instagram"></i></a>
                </li>
            </ul>
...
<section id="contact" class="s-contact">
    ...
    <div class="row section-header" data-aos="fade-up">
        <div class="col-full">
            ...
            <p>
                <button type="button" onclick="location.href = '#'"><i class="fab fa-facebook"></i> Facebook</button>
                <button type="button" onclick="location.href = '#'"><i class="fab fa-twitter"></i> Twitter</button>
                <button type="button" onclick="location.href = '#'"><i class="fab fa-instagram"></i> Instagram</button>
            </p>
            ...
            <form id="contact-form" action="">
                ...
                <div id="section-permission" class="section">
                    <label for="phone" class="input-label">Comment
                        <input id="contact-comment" name="comment" class="input-text" value="" / >
                    </label>
                </div>
