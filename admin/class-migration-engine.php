...
/**
 * For more documentation, see the class LG_Migration in file
 * dt-core/migrations/abstract.php
 */
class Disciple_Tools_Porch_Template_Migration_Engine
{
        ...
        foreach ( $filenames as $filename ) {
            if ( $filename[0] !== "." && $filename !== "abstract.php"){
                if ( preg_match( '/^([0-9][0-9][0-9][0-9])(-.*)?\.php$/i', $filename, $matches ) ) {
                    ...
                    $migration_name = sprintf( "Disciple_Tools_Porch_Template_Migration_%04d", $got_migration_number );
     ...
     *
     * @throws \Exception ...
     * @throws \Disciple_Tools_Porch_Template_Migration_Lock_Exception ...
     * @throws \Throwable ...
     */
    public static function migrate( int $target_migration_number ) {
        ...
        while ( true ) {
            ...
            if ( (int) get_option( 'lg_public_porch_lock', 0 ) ) {
                throw new Disciple_Tools_Porch_Template_Migration_Lock_Exception();
            }
...
class Disciple_Tools_Porch_Template_Migration_Lock_Exception extends Exception
{
