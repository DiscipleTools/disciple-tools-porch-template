...
if ( ! defined( 'PORCH_TITLE' ) ) {
    define( 'PORCH_TITLE', 'Home Blank' ); // Used in tabs and titles, avoid special characters. Spaces are okay.
}
...
if ( ! defined( 'PORCH_TYPE' ) ) {
    define( 'PORCH_TYPE', 'blank' ); // Alphanumeric key. Use underscores not hyphens. No special characters.
}
if ( ! defined( 'PORCH_TOKEN' ) ) {
    define( 'PORCH_TOKEN', 'porch_app_blank' ); // Alphanumeric key. Use underscores not hyphens. No special characters. Must be less than 20 characters
}

class DT_Porch_Template_Home_Blank extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
...
DT_Porch_Template_Home_Blank::instance();
