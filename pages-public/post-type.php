...
/**
 * Disciple_Tools_Porch_Template_Landing_Post_Type Class
 * All functionality pertaining to project update post types in Disciple_Tools_Porch_Template_Landing_Post_Type.
 *
 * @package  Disciple_Tools
 * @since    0.1.0
 */
class Disciple_Tools_Porch_Template_Landing_Post_Type
{
...
Disciple_Tools_Porch_Template_Landing_Post_Type::instance();
